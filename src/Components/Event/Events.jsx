           ...
           <LeftSideBar2/>
            <div className="col-md-8 col-lg-6 vstack gap-4">
              <div
                ...
                role="alert"
              >
                <strong>Upcoming event:</strong> The learning conference on Sep
                19 2024{" "}
                <Link
                  to="/events-details"
                  className="btn btn-xs btn-success mt-2 mt-md-0 ms-md-4"
                >
                  {" "}
                  View event
                </Link>
  ...
  <div className="row g-4">
    <div className="col-sm-6 col-xl-4">
      ...
      <div className="card h-100">
        ...
        <div className="card-body position-relative pt-0">
          {/* Tag */}
          <Link className="btn btn-xs btn-primary mt-n3" to="/events-details">
            Meeting
          </Link>
          <h6 className="mt-3">
            {" "}
            <Link to="/events-details"> Old dominion </Link>{" "}
          </h6>
          {/* Date time */}
          <p className="mb-0 small">
            {" "}
    ...
    <div className="col-sm-6 col-xl-4">
      ...
      <div className="card h-100">
        ...
        <div className="card-body position-relative pt-0">
          ...
          <h6 className="mt-3">
            {" "}
            <Link to="/events-details"> Beach event </Link>{" "}
          </h6>
          {/* Date time */}
          <p className="mb-0 small">
            {" "}
    ...
    <div className="col-sm-6 col-xl-4">
      ...
      <div className="card h-100">
        ...
        <div className="card-body position-relative pt-0">
          ...
          <h6 className="mt-3">
            {" "}
            <Link to="/events-details"> Lewis black tickets </Link>{" "}
          </h6>
          {/* Date time */}
          <p className="mb-0 small">
            {" "}
