...
import eliment7 from "../../assets/images/elements/07.svg";
import eliment1 from "../../assets/images/elements/01.svg";
import eliment10 from "../../assets/images/elements/10.svg";
import eliment4 from "../../assets/images/elements/04.svg";
import eliment2 from "../../assets/images/elements/02.svg";
import eliment5 from "../../assets/images/elements/05.svg";
import eliment3 from "../../assets/images/elements/03.svg";
import eliment9 from "../../assets/images/elements/09.svg";
import eliment6 from "../../assets/images/elements/06.svg";
        ...
        <nav className="navbar navbar-expand-lg">
          <div className="container">
            ...
            <div className="ms-3 ms-lg-auto">
              <Link className="btn btn-dark" to="/landing-page/sign-in-advance">
                {" "}
                Sign In{" "}
              </Link>
            </div>
      ...
      <main>
        <div className="pt-5 pb-0 position-relative">
          ...
          <div className="container">
            ...
            <div className="row g-0 align-items-center mt-2 position-relative z-index-1">
              <div className="col-lg-4">
                ...
                <div className="iphone-x iphone-x-small iphone-bg-img">
                  <i />
                  <b />
                </div>
                {/* iphone-x mockup END */}
                  ...
                  <div className="mac_scaler">
                    <div className="mac_holder">
                      <div className="mac_screen">
                        ...
                        <div className="mac_screen_content mac-bg-img"></div>
                      </div>
          ...
          <div className="position-absolute top-0 end-0 mt-5 pt-5">
            <img className="h-300px blur-9 mt-5 pt-5" src={eliment7} alt="" />
          </div>
          <div className="position-absolute top-0 start-0 mt-n5 pt-n5">
            <img className="h-300px blur-9" src={eliment1} alt="" />
          </div>
          <div className="position-absolute top-50 start-50 translate-middle">
            <img className="h-300px blur-9" src={eliment4} alt="" />
          </div>
          {/* Svg decoration END */}
        </div>
          ...
          <div className="container">
            ...
            <div className="row g-4 g-lg-5">
              ...
              <div className="col-md-4 text-center">
                <img className="h-100px mb-4" src={eliment2} alt="" />
              ...
              {/* Feature START */}
              <div className="col-md-4 text-center">
                <img className="h-100px mb-4" src={eliment7} alt="" />
              ...
              {/* Feature START */}
              <div className="col-md-4 text-center">
                <img className="h-100px mb-4" src={eliment1} alt="" />
            ...
            <div className="row g-4 g-lg-5 align-items-center">
                ...
                <div className="card card-body bg-mode shadow-none border-0 p-4 p-sm-5 pb-sm-0 overflow-hidden">
                  <div className="row g-4">
                    <div className="col-md-6">
                      {/* Info */}
                      <img className="h-50px" src={eliment5} alt="" />
                    ...
                    <div className="col-md-6 text-end">
                      {/* image */}
                      {/* iphone-x mockup START */}
                      <div className="iphone-x iphone-x-small iphone-x-half mb-n5 mt-0 iphoneHalf-bg-img">
                        <i />
                        <b />
                      </div>
                      {/* iphone-x mockup END */}
              ...
              <div className="col-md-4">
                <div className="card card-body bg-mode shadow-none border-0 p-4 p-lg-5">
                  {/* Image */}
                  <div>
                    <img className="h-50px" src={eliment3} alt="" />
                  </div>
                  {/* Info */}
              ...
              <div className="col-md-4">
                <div className="card card-body bg-mode shadow-none border-0 p-4 p-lg-5">
                  {/* Image */}
                  <div>
                    <img className="h-50px" src={eliment9} alt="" />
                  </div>
                  {/* Info */}
              ...
              <div className="col-md-4">
                <div className="card card-body bg-mode shadow-none border-0 p-4 p-lg-5">
                  {/* Image */}
                  <div>
                    <img className="h-50px" src={eliment6} alt="" />
                  </div>
                  {/* Info */}
        ...
        <div className="py-4 py-sm-5 position-relative">
          {/* Svg decoration START */}
          <div className="position-absolute top-0 start-0 mt-n5 pt-n5">
            <img className="h-300px blur-9" src={eliment6} alt="" />
          </div>
          {/* Svg decoration END */}
          <div className="container">
            <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="me-4">
                      ...
                      <div className="mb-3 d-flex align-items-start">
                        <img className="h-40px" src={eliment4} alt="" />
                        <div className="ms-4">
                      ...
                      {/* Support artists   */}
                      <div className="mb-3 d-flex align-items-start">
                        <img className="h-40px" src={eliment10} alt="" />
                        <div className="ms-4">
